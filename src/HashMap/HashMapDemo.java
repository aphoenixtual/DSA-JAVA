...
public class HashMapDemo {
    ...
    public static void main(String[] args) {
        ...
        map.put(" Grand Opera House, Belfast", 100);
        System.out.println(map);

        map.put("Indira Gandhi Arena", 325);
        System.out.println(map);

        System.out.println(map.get("Indira Gandhi Arena"));
        System.out.println(map.get("Bridgewater Hall, Manchester, UK"));
        ...
        String str = "Bridgewater Hall, Manchester, UK";
